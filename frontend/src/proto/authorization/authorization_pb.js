...
if (goog.DEBUG && !COMPILED) {
  proto.authorization.PasswordChange.displayName = 'proto.authorization.PasswordChange';
}
 ...
 * @return {!Object}
 */
proto.authorization.PasswordChange.prototype.toObject = function(opt_includeInstance) {
  return proto.authorization.PasswordChange.toObject(opt_includeInstance, this);
};
...
proto.authorization.PasswordChange.deserializeBinary = function(bytes) {
  ...
  return proto.authorization.PasswordChange.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.authorization.PasswordChange}
 */
proto.authorization.PasswordChange.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.authorization.PasswordChange.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
