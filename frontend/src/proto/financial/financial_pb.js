 ...
 * @return {!Object}
 */
proto.financial.PaymentParams.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.financial.PaymentParams}
 */
proto.financial.PaymentParams.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.financial.PaymentParams.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
...
proto.financial.Expenses = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.financial.Expenses.repeatedFields_, null);
};
...
proto.financial.Expenses.toObject = function(includeInstance, msg) {
  var f, obj = {
    expenseList: jspb.Message.toObjectList(msg.getExpenseList(),
    proto.financial.Expense.toObject, includeInstance)
  };
...
proto.financial.Expenses.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.financial.Expense.deserializeBinaryFromReader);
...
proto.financial.Expenses.prototype.getExpenseList = function() {
  return /** @type{!Array<!proto.financial.Expense>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.financial.Expense, 1));
};
...
proto.financial.Expenses.prototype.addExpense = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.financial.Expense, opt_index);
};
...
proto.financial.Params.prototype.getQuery = function() {
  return /** @type{?proto.products.Query} */ (
    jspb.Message.getWrapperField(this, products_products_pb.Query, 5));
};
...
proto.financial.Payoff = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.financial.Payoff.repeatedFields_, null);
};
...
proto.financial.Payoff.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.financial.SectorProfit.toObject, includeInstance),
...
proto.financial.Payoff.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      reader.readMessage(value,proto.financial.SectorProfit.deserializeBinaryFromReader);
...
proto.financial.Payoff.prototype.getSectorsList = function() {
  return /** @type{!Array<!proto.financial.SectorProfit>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.financial.SectorProfit, 6));
};
...
proto.financial.Payoff.prototype.addSectors = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.financial.SectorProfit, opt_index);
};
 ...
 * @return {!Object}
 */
proto.financial.SectorProfit.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.financial.SectorProfit}
 */
proto.financial.SectorProfit.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.financial.SectorProfit.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
