...
export default function FinancialBoard(props) {
  ...
  return (
    <div className="col-md-4 p-3 right-border">
      <h3>
        <span className="text-warning" style={{ marginRight: "0.5rem" }}>
      ...
      <div className="row">
        <div className="col-6 d-flex flex-column justify-content-between p-0">
          ...
          <div className="d-flex flex-column p-3">
            Received
            <span style={{ color: "lightgreen" }} className="font-weight-bold">
        ...
        <div className="col-6 d-flex flex-column justify-content-between p-0">
          ...
          <div className="d-flex flex-column p-3">
            Expenses
            <span style={{ color: "orange" }} className=" font-weight-bold">
              R$ 000.000,000
            </span>
          </div>
          <div className="d-flex flex-column p-3">
            To be paid
            <span className="text-danger font-weight-bold">R$ 000.000,000</span>
          </div>
        </div>
      </div>
    </div>
